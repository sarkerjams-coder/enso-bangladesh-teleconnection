...
# Output folder
output_folder = r"D:/Research/MATLAB/Daubechies/Precipitation/Monthly/Target Nino/Individual_Station/Single Input for X/Combined_rx5day_MON/LGBM/Nino_3.4/Level 7"
