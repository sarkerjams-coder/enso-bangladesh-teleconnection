...
# Output folder
output_folder = r"D:/Research/MATLAB/Daubechies/Precipitation/Monthly/Target Nino/All stations as X/Multiple Input for X/LGBM/Nino_3.4/Level 7"
...
df1 = load_with_prefix(file1)
df2 = load_with_prefix(file2)
df3 = load_with_prefix(file3)
df4 = load_with_prefix(file4)
df5 = load_with_prefix(file5)
