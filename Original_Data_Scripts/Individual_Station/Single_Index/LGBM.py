...
# Output folder
output_folder = r"D:/Research/Journal/LGBM, RF, XGB/Precipitation/Monthly/Individual_Station/Single Input for X/LGBM/Combined_rx5day_MON/Nino_3.4"
...
summary_df.to_excel(
    os.path.join(
        output_folder,
        "LGBM_All_Stations_Metrics.xlsx"
    ),
    index=False
)
