...
# Output folder
output_folder = r"D:/Research/Journal/LGBM, RF, XGB/Precipitation/Monthly/Individual_Station/Single Input for X/XGB/Combined_rx5day_MON/Nino_3.4"
...
for station in stations:
    ...
    X.to_excel(
        os.path.join(
            station_folder,
            "XGB_Combined_all_X_data_raw.xlsx"
        ),
        index=False
    )
    ...
    metrics_df.to_excel(
        os.path.join(station_folder, "XGB_Model_Metrics_raw.xlsx"),
        index=False
    )
    ...
    train_predictions_df.to_excel(
        os.path.join(station_folder, "XGB_Training_Predictions.xlsx"),
        index=False
    )
    ...
    test_predictions_df.to_excel(
        os.path.join(station_folder, "XGB_Testing_Predictions.xlsx"),
        index=False
    )
