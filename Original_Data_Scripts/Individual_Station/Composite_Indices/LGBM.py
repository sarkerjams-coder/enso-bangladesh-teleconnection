...
# Output folder
output_folder = r"D:/Research/Journal/LGBM, RF, XGB/Precipitation/Monthly/Individual_Station/Multiple Input for X/Nino_3.4"
...
for station in stations:
    ...
    X.to_excel(
        os.path.join(
            station_folder,
            "LGBM_Combined_all_X_data_raw.xlsx"
        ),
        index=False
    )
