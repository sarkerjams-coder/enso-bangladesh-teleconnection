...
# Output folder
output_folder = r"D:/Research/Journal/LGBM, RF, XGB/Precipitation/Monthly/All stations as X/Single Input for X/LGBM/Combined_rx5day_MON/Nino_3.4"
...
# Save combined X
X.to_excel(
    os.path.join(output_folder, "LGBM_Combined_all_X_data_raw.xlsx"),
    index=False
)
