...
# 1. FILE PATHS
# ==========================================
file1 = r"D:/Research/Journal/LGBM, RF, XGB/Precipitation/Monthly/Combined_rx5day_MON.csv"

enso_file = r"D:/Research/Journal/LGBM, RF, XGB/Precipitation/Monthly/Nino_3_3.4_4_(HadISST)_from 1982.xlsx"

# Output folder
output_folder = r"D:/Research/Journal/LGBM, RF, XGB/Precipitation/Monthly/All stations as X/Single Input for X/XGB/Combined_rx5day_MON/Nino_3.4"
...
# Save combined X
X.to_excel(
    os.path.join(output_folder, "XGB_Combined_all_X_data_raw.xlsx"),
    index=False
)
...
metrics_df.to_excel(
    os.path.join(output_folder, "XGB_Model_Metrics_raw.xlsx"),
    index=False
)
...
train_predictions_df.to_excel(
    os.path.join(output_folder, "XGB_Training_Predictions_raw.xlsx"),
    index=False
)
...
test_predictions_df.to_excel(
    os.path.join(output_folder, "XGB_Testing_Predictions_raw.xlsx"),
    index=False
)
